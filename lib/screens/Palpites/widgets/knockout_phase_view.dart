...
class KnockoutPhaseView extends StatelessWidget {
  ...
  List<Map<String, String?>> _getConfrontos(int phase, MataMataProvider mataMata, String? Function(int) timeDoSlot) {
    switch (phase) {
      case 1:
        final esq = List.generate(8, (i) {
          final a = 1 + i * 2;
          return {'timeA': mataMata.slots[a], 'timeB': mataMata.slots[a + 1]};
        });
        final dir = List.generate(8, (i) {
          final a = 17 + i * 2;
          return {'timeA': mataMata.slots[a], 'timeB': mataMata.slots[a + 1]};
        });
        return esq + dir;
      ...
      case 4:
        return [
          {'timeA': timeDoSlot(57), 'timeB': timeDoSlot(58)},
          {'timeA': timeDoSlot(59), 'timeB': timeDoSlot(60)},
        ];
      case 5:
        return [
          {'timeA': timeDoSlot(63), 'timeB': timeDoSlot(64)},
          {'timeA': timeDoSlot(61), 'timeB': timeDoSlot(62)},
        ];
      default:
        return [];
    }
